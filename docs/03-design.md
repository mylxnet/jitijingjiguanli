...
| 状态 | 评审中 |
| 创建日期 | 2026-09-02 |
| 依赖文档 | [需求澄清记录](./01-requirements.md)、[PRD](./02-prd.md) |
...
| 异常 | 处理 |
|------|------|
| 会话过期 | 任意 API 返回 401 → 清除本地状态 → 跳转 `/login` 并提示「登录已过期」 |
